...
@section('content')
    ...
    <form style="width: 100%" action="AboutStore" method="post" enctype="multipart/form-data"  class="box-header with-border box box-primary container col-md-12">
        {{csrf_field()}}
        <div style="width: 50%" class="  col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" type="text" name="detail_en" rows="10"> </textarea>
            </div>
            <div class="form-group">
